...
const vertexShader = /* glsl */`
  ...
  void main(){
    vUv = uv;
    vec3 pos = position;
    float n = cnoise(vec3(pos.x * 0.4 + uTime * 0.08, pos.y * 0.4, uTime * 0.05));
    float n2 = cnoise(vec3(pos.x * 0.8, pos.y * 0.8 + uTime * 0.07, 0.0)) * 0.5;
    float elevation = (n + n2) * 0.45;
    pos.z += elevation;
...
function WaveMesh() {
  ...
  const uniforms = useMemo(
    () => ({
      uTime: { value: 0 },
      uColorA: { value: new THREE.Color('#060608') },
      uColorB: { value: new THREE.Color('#00ffe6') },
